...
$strAfterInsertNewInsert = 'anschliessend einen weiteren Datensatz einfügen';
$strAfterInsertNext = 'nächste Zeile bearbeiten';
$strAfterInsertSame = 'Zurück zu dieser Seite';
$strAfter = 'Nach %s';
$strAll = 'Alle';
$strAllowInterrupt = 'Abbruch wenn die maximale Scriptlaufzeit erreicht wird. Damit ist es möglich grosse Dateien zu importieren, allerdings kann es Transaktionen zerstören.';
...
$strBookmarkReplace = 'Ãœberschreibe gleichnamiges Bookmark';
...
$strChangeCopyModeDeleteAndReload = ' ... lösche den alten und lade anschliessend die Benutzertabellen neu.';
...
$strChangeCopyModeRevoke = ' ... entziehe dem alten alle Rechte und lösche ihn anschliessend.';
...
$strCheckPrivsLong = 'Ãœberprüft die Rechte für die Datenbank &quot;%s&quot;.';
$strCheckPrivs = 'Rechte überprüfen';
$strCheckTable = 'Ãœberprüfe Tabelle';
...
$strCreationDates = 'Erzeugungs- / Aktualisierungs- / Ãœberprüfungszeiten';
...
$strDefaultEngine = 'Neue Tabellen werden standardmässig im Format %s angelegt.';
$strDefault = 'Standard';
...
$strDeleteAndFlush = 'Die Benutzer löschen und die Benutzertabellen anschliessend neu laden.';
...
$strFileAlreadyExists = 'Die Datei %s besteht bereits auf dem Server. Bitte ändern Sie den Dateinamen oder wählen Sie die Ãœberschreibungs-Option.';
...
$strInnoDBAutoextendIncrement = 'Autoerweiterungs-Schrittgrösse';
$strInnoDBAutoextendIncrementDesc = 'Die Grösse, um die ein Tablespace erweitert wird, wenn er voll ist.';
$strInnoDBBufferPoolSizeDesc = 'Die Grösse des Arbeitsspeicherpuffers, den InnoDB verwendet, um Daten und Indizes zwischenzuspeichern.';
$strInnoDBBufferPoolSize = 'Grösse des Puffer-Pools';
...
$strInsecureMySQL = 'Ihre Konfigurationsdatei enthält Einstellungen (Benutzer &quot;root&quot; ohne Passwort), welche denen des MySQL-Standardbenutzers entsprechen. Wird Ihr MySQL-Server mit diesen Einstellungen betrieben, so können Unbefugte leicht von aussen auf ihn zugreifen. Sie sollten diese Sicherheitslücke unbedingt schliessen!';
...
$strInvalidColumnCount = 'Die Spaltenanzahl muss grösser als 0 sein.';
...
$strMaximumSize = 'Maximale Dateigrösse: %s%s';
...
$strMyISAMDataPointerSizeDesc = 'Standardmässige Grösse des Zeigers, welcher von CREATE TABLE für MyISAM-Tabellen verwendet wird, sofern die Option MAX_ROWS nicht angegeben wird.';
$strMyISAMDataPointerSize = 'Grösse des Datenzeigers';
$strMyISAMMaxExtraSortFileSizeDesc = 'Wenn das Erzeugen der temporären Datei für schnelle Index-Erzeugung um diesen Wert grösser sein würde als die Benutzung des Schlüssel-Caches, wird die Schlüssel-Cache-Methode bevorzugt.';
$strMyISAMMaxExtraSortFileSize = 'Maximum Grösse temporärer Dateien bei Indexerstellung';
$strMyISAMMaxSortFileSizeDesc = 'Die maximale Grösse der temporären Datei, die MySQL benutzen darf, während es den Index erzeugt (während REPAIR, ALTER TABLE oder LOAD DATA INFILE).';
$strMyISAMMaxSortFileSize = 'Maximale Grösse temporärer Dateien beim Sortieren';
...
$strMyISAMRepairThreadsDesc = 'Wenn dieser Wert grösser als 1 ist, werden MyISAM-Tabellenindizes während einer Reparatur oder eines Sortierungsprozesses parallel erstellt (jeder Index in einem separatem Prozess).';
...
$strMyISAMSortBufferSize = 'Grösse des Sortierungspuffers';
...
$strNoDataReceived = 'Es wurden keinen Daten zum importieren empfangen. Entweder wurde keine Datei ausgewählt, oder die Dateigrösse hat die maximal erlaubte Grösse der PHP Konfiguration überschritten. Siehe FAQ 1.16.';
...
$strQueryWindowLock = 'Abfrage vor Ã„nderungen ausserhalb des Fensters schützen';
...
$strRevokeAndDelete = 'Den Benutzern alle Rechte entziehen und sie anschliessend aus den Benutzertabellen löschen.';
...
$strShowStatusBinlog_cache_disk_useDescr = 'Anzahl der Transaktionen die den Binarylog-Cache verwendet, aber die Grösse des Binarylog-Caches (binlog_cache_size) überschritten und eine temporäre Datei verwendet haben um die Statements der Transaktion zu speichern.';
...
$strShowStatusInnodb_buffer_pool_pages_totalDescr = 'Die Grösse des Puffer-Pools in Seiten.';
$strShowStatusInnodb_buffer_pool_read_ahead_rndDescr = 'Anzahl "random" read-aheads durch InnoDB. Dies geschieht wenn eine Abfrage einen grossen Teil einer Tabelle durchsucht aber in zufälliger Reihenfolge.';
...
$strShowStatusInnodb_buffer_pool_wait_freeDescr = 'Normalerweise geschehen Schreibvorgänge im InnoDB Zwischenspeicher im Hintergrund. Abber wenn es nötig ist eine Seite zu lesen oder zu erstellen und es ist keine saubere Seite verfügbar dann ist es notwendig darauf zu warten das Seiten weggeschrieben werden. Dieser Wert gibt wieder wie oft das geschehen ist. Wenn die Zwischenspeicher-Grösse korrekt eingestellt ist sollte dieser Wert klein sein.';
...
$strShowStatusInnodb_page_sizeDescr = 'Die fest kompilierte InnnoDB Seitengrösse (Standard 16 KiB). Viele Werte werden in Seiten gezählt; die Seitengrösse erlaubt es diese einfach in Byte umzurechnen.';
...
$strShowStatusQcache_lowmem_prunesDescr = 'Die Anzahl der Abfragen die aus dem Cache entfernt wurden, um Speicher für neue Abfragen frei zu geben. Dieser Wert kann helfen die Abfrage-Cache-Grösse zu optimieren. Der Abfrage-Cache arbeitet nach der LRU-Strategie (least recently used), d.&nbsp;h. es wird stets die Abfrage gelöscht, die am längsten unbenutzt im Cache lag.';
...
$strUploadLimit = 'Möglicherweise wurde eine zu grosse Datei hochgeladen. Bitte lesen Sie die %sDokumentation%s zur Lösung diese Problems.';
...
$strReload = 'Neuladen';
$strSmallBigAll = 'Alles klein/gross';
...
$strToggleSmallBig = 'Wechseln klein/gross';
