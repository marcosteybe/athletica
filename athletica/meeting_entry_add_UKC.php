...
{   
   ...
   if($club == 0){
    ...
    elseif (!check_email($_POST['email']) && $license == 0) {              
...
?>
	...
	function check_category(asfb){ 
        ...
        */
        ...
        if (typeof(asfb) == 'boolean') {
           document.location.href='meeting_entry_add_UKC.php?argument=change_sex&asfb='+asfb+'&name='+gName+'&firstname='+gFirstname+'&day='+gDay+'&month='+gMonth+'&year='+gYear+'&sex='+gSex+'&country='+gCountry+'&region='+gRegion+'&clubtext='+gClubText+'&club='+gClub+'&clubnr='+gClubNr+'&clubinfo='+gClubInfo+'&club2='+gClub2+'&startnbr='+gStartnbr+'&category='+gCategory+'&team='+gTeam+'&combined='+gCombined+gDisc+gComb+'&licNr='+gLicNr+'&licPrinted='+gLicPrinted+'&athleteId='+gAthleteId+'&licType='+gLizType;                                                                                                                                                                                
        }  
        else {
            document.location.href='meeting_entry_add_UKC.php?argument=change_sex&name='+gName+'&firstname='+gFirstname+'&day='+gDay+'&month='+gMonth+'&year='+gYear+'&sex='+gSex+'&country='+gCountry+'&region='+gRegion+'&clubtext='+gClubText+'&club='+gClub+'&clubnr='+gClubNr+'&clubinfo='+gClubInfo+'&club2='+gClub2+'&startnbr='+gStartnbr+'&category='+gCategory+'&team='+gTeam+'&combined='+gCombined+gDisc+gComb+'&licNr='+gLicNr+'&licPrinted='+gLicPrinted+'&athleteId='+gAthleteId+'&licType='+gLizType;                                                                                                                                                                                                                                                                         
        }
	...
	function change_asfb(asfb){
		...
		document.location.href='meeting_entry_add_UKC.php?asfb='+asfb+'&name='+gName+'&firstname='+gFirstname+'&day='+gDay+'&month='+gMonth+'&year='+gYear+'&sex='+gSex+'&country='+gCountry+'&region='+gRegion+'&club='+gClub+'&clubinfo='+gClubInfo+'&club2='+gClub2+'&startnbr='+gStartnbr+'&category='+gCategory+'&team='+gTeam+'&combined='+gCombined+gDisc+gComb;
	...
	function change_licType(o){
		...
		document.location.href = 'meeting_entry_add_UKC.php?licType='+o.value+'&name='+gName+'&firstname='+gFirstname+'&day='+gDay+'&month='+gMonth+'&year='+gYear+'&sex='+gSex+'&country='+gCountry+'&region='+gRegion+'&club='+gClub+'&clubinfo='+gClubInfo+'&club2='+gClub2+'&startnbr='+gStartnbr+'&category='+gCategory+'&team='+gTeam+'&combined='+gCombined+gDisc+gComb;
...
<tr>
   ...
   <tr>
    ...
    <input name='plz' type='text'
        maxlength='4' value='<?php echo $plz; ?>'
       size="4" >
