...
if (!defined('AA_CL_EXPORT_PAGE_LIB_INCLUDED')) {
    ...
    class EXPORT_RankingListDiplom extends EXPORT_Page
    {
        ...
        function printHeaderLine($title, $relay = FALSE, $points = FALSE, $wind = FALSE, $heatwind = '', $time = "", $svm = false)
        {
    ...
    class EXPORT_RankingListDiplomLSGBrugg extends EXPORT_RankingListDiplom
    {
        ...
        function printLine($rank, $name, $year, $club, $perf, $wind, $points, $qual, $country)
        {
            ...
            $catDummy = explode(' ', $this->cat); // array deref not possible with my crappy php version
            $catNeu = $catDummy[0];
            $newDisc =  str_replace(' ', '', $this->disc);
            ...
            $this->printCsvLine(array($titel, $rank, $nameNeu, $vorname, $yearNeu, $country, $club, $perf, $points, $catNeu, $newDisc, $this->round));
        }
        ...
        function printHeaderLine($title, $relay = FALSE, $points = FALSE, $wind = FALSE, $heatwind = '', $time = "", $svm = false)
        {
            ...
            $params[] = $year;
            $params[] = $ioc;
            $params[] = $svm ? $GLOBALS['strTeam'] : $GLOBALS['strClub'];
            $params[] = $GLOBALS['strPerformance'];
            $params[] = $GLOBALS['strPoints'];
            $params[] = $GLOBALS['strCategory'];
            $params[] = $GLOBALS['strDiscipline'];
