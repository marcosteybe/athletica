 ...
 UPDATE `disziplin` SET Typ = 5 WHERE Code = 331;   
...
(35, '36.09 Mixed Team U12 M und U12 W', '36_09');
 ...
 ALTER TABLE `serienstart` ADD `Position2` int( 11 ) NOT NULL default '0' AFTER `Bemerkung` ;  
 ALTER TABLE `serienstart` ADD `Position3` int( 11 ) NOT NULL default '0' AFTER `Position2` ; 
