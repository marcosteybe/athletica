...
-- 
-- Host: localhost
-- Erstellungszeit: 25. August 2006 um 13:37
...
CREATE TABLE `anmeldung` (
  ...
  KEY `xTeam` (`xTeam`)
) TYPE=MyISAM AUTO_INCREMENT=748 ;
...
) TYPE=MyISAM AUTO_INCREMENT=9073 ;
...
CREATE TABLE `base_performance` (
  ...
  `best_effort` varchar(10) NOT NULL default '',
  `season_effort` varchar(10) NOT NULL default '',
  `notification_effort` varchar(10) NOT NULL default '',
  PRIMARY KEY  (`id_performance`),
  KEY `id_athlete` (`id_athlete`)
) TYPE=MyISAM AUTO_INCREMENT=933 ;
...
-- 
-- Tabellenstruktur für Tabelle `omega_konfiguration`
-- 

CREATE TABLE `omega_konfiguration` (
  `xOMEGA_Konfiguration` int(11) NOT NULL auto_increment,
  ...
  `xMeeting` int(11) NOT NULL default '0',
  PRIMARY KEY  (`xOMEGA_Konfiguration`),
  KEY `xMeeting` (`xMeeting`)
) TYPE=MyISAM AUTO_INCREMENT=1 ;
...
) TYPE=MyISAM AUTO_INCREMENT=1405 ;
...
CREATE TABLE `runde` (
  ...
  PRIMARY KEY  (`xRunde`),
  UNIQUE KEY `WettkampfRunde` (`xWettkampf`,`xRundentyp`),
...
CREATE TABLE `rundenlog` (
  ...
  KEY `Zeit` (`Zeit`),
  KEY `Runde` (`xRunde`)
) TYPE=MyISAM AUTO_INCREMENT=1063 ;
...
) TYPE=MyISAM AUTO_INCREMENT=1767 ;
...
CREATE TABLE `staffel` (
  ...
  UNIQUE KEY `NamVerMeetKatTeam` (`Name`,`xVerein`,`xMeeting`,`xKategorie`,`xTeam`),
  KEY `xMeeting` (`xMeeting`),
  KEY `xVerein` (`xVerein`),
  KEY `Name` (`Name`(10)),
  KEY `xTeam` (`xTeam`)
...
) TYPE=MyISAM AUTO_INCREMENT=1647 ;
...
CREATE TABLE `verein` (
  ...
  KEY `xCode` (`xCode`)
) TYPE=MyISAM AUTO_INCREMENT=584 ;
...
CREATE TABLE `wettkampf` (
  ...
  `xMehrkampfcode` int(11) NOT NULL default '0',
  `xKategorie_svm` int(11) NOT NULL default '0',
  PRIMARY KEY  (`xWettkampf`),
  KEY `xKategorie` (`xKategorie`),
  KEY `xDisziplin` (`xDisziplin`),
  KEY `xMeeting` (`xMeeting`)
) TYPE=MyISAM AUTO_INCREMENT=427 ;
