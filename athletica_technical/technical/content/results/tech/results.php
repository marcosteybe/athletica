    ...
    if($currentAthleteID == 0) {
        ...
        <table>
            ...
            <tr>
                ...
                <td><button type="button" name="setNAA" id="setNAA"><?=$lg['RESULT_INVALID_NAA_BUTTON']?></button></td>
                <td><button type="button" name="setWAI" id="setWAI"><?=$lg['RESULT_INVALID_WAI_BUTTON']?></button></td>
                <td>
                    <?php
                    if(getNofResults(CFG_CURRENT_EVENT, $currentAthleteID, 0, false) == 0) {
                    ?>
        ...
        <table>
            ...
            ?>
            <tr>
                <td class="result_title"><?=$lg['PERFORMANCE']?>:</td>
                <td></td>
                <td class="wind_title">
                    <?php
            ...
            <tr>
                ...
                <td class="result"><input type="text" name="res_result" id="res_result" class="result" autocomplete="off" tabindex="1">
