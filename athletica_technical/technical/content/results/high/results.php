...
if(CFG_CURRENT_EVENT > 0) {
    ...
    if($checkStartHeights) {
        ...
        $currentAthlete = getCurrentAthlete($athletes);
    ...
    if(!$checkStartHeights){
        ...
        <table>
            ...
            <tr>
                <td><?=$currentAthleteData['ath_bib']?></td>
                <td><?=$currentAthleteData['ath_name']?> <?=$currentAthleteData['ath_firstname']?></td>
                <td><?=$currentAthleteData['ath_club']?></td>
                <td>
                    <?php
                    if(checkFirstAttempt($currentAthleteID)) {
                        ?>
        ...
        <table>
            ...
            ?>
            <tr>
                <td class="result_title" colspan="4"><b><?=$currentAttempt.". ".$lg['ATTEMPT']?></b></td>
                <td class="result_title"><b><?=formatResultOutput($currentHeight).$lg['METER_SHORT']?></b></td>
                <td></td>
            ...
            <tr>
                <td><button type="button" class="high_button_input" name="setPassed" id="setPassed" result="<?=$currentResult.$glb_high_attempt_passed?>"><?=$lg['RESULT_HIGH_PASSED_BUTTON']?></button></td>
                <td></td>
                <td><button type="button" class="high_button_input" name="setFailed" id="setFailed" result="<?=$currentResult.$glb_high_attempt_failed?>"><?=$lg['RESULT_HIGH_FAILED_BUTTON']?></button></td>
                <td></td>
                <td><button type="button" class="high_button_input" name="setWaived" id="setWaived" result="<?=$currentResult.$glb_high_attempt_waived?>"><?=$lg['RESULT_HIGH_WAIVED_BUTTON']?></button></td>
                <td></td>
        ...
        <table>
            ...
            if($last) {
                ...
                <tr>
                    ...
                    <td><?=$nextAttempt.". ".$lg['ATTEMPT']?></td>
                    <td><?=formatResultOutput($nextAthlete['curr_height']).$lg['METER_SHORT']?></td>
                </tr>
                <?php
            }
            ?>
