...
<table class="event_settings">
    ...
    <tr class="event_settings">
        <td><?=$lg['TO']?>&nbsp;&nbsp;<input type="text" name="diffUntil" id="diffUntil" class="diffHeight number required" value="<?=formatResultOutput($settings['diff_1_until'])?>"> :</td>
